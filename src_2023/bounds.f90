...
!..............................................................................
		...
		dn = 2.0d0*c*k_w*tanh(k_w*(-c*ctime)+tau)/(cosh(k_w*(-c*ctime)+tau))**2.0! dn,ddn,dddn = 1st 2nd 3rd derivatives d/dt of n_h
		ddn=2.0d0*c**2.0*k_w**2.0*(cosh(2.0d0*tau)-2.0d0)/(cosh(tau))**4.0
		dddn = 4.0d0*c**3.0*k_w**3.0*(cosh(2.0*tau)-5.0d0)*tanh(tau)/(cosh(tau))**4.0
...
!...............................................................................
        if (dom(ib)%inext.lt.0) then
          ...
          else if(dom(ib)%bc_east.eq.21) then
            if (alfabc.eq.1)then
              if(L_LSM) then
                do k=ks-1,ke+1; do j=js-1,je+1
...
!...............................................................................
     ...
     &						+Fwallw*alfapr*dt
          ...
          else if (dom(ib)%bc_west.eq.31) then    !===Aristos Christou Soitary Wave
            H=0.02d0; k_w=sqrt(3.0d0*H/(4.0d0*length**3.0))         !specify some parameters for solitary wave
            c=sqrt(9.81*(H+length)); tau= 8.0d0; ep=H/length
            n_h = 1.0d0/(cosh(k_w*(-c*ctime)+tau))**2.0
            dn = 2.0d0*c*k_w*tanh(k_w*(-c*ctime)+tau)/(cosh(k_w*(-c*ctime)+tau))**2.0
            ddn=2.0d0*c**2.0*k_w**2.0*(cosh(2.0d0*tau)-2.0d0)/(cosh(tau))**4.0
            dddn = 4.0d0*c**3.0*k_w**3.0*(cosh(2.0*tau)-5.0d0)*tanh(tau)/(cosh(tau))**4.0
            if (L_LSM) then
              do k=ks-1,ke+1; do j=js-1,je+1
