!#######################################################################
! SUBROUTINES: - exchangeu
!#######################################################################
      SUBROUTINE exchangeu(op,nly)
!-----------------------------------------------------------------------
!     The streamwise velocity variables (u,ustar) are exchanged between
!     the neighbouring subdomains ghost-cells with a different LMR level
!#######################################################################
      use multidata
      use mpi
      use vars
