!#######################################################################
! SUBROUNTINES: - exchange_phi
!#######################################################################
      SUBROUTINE  exchange_phi(op,nly)
!-----------------------------------------------------------------------
!     The level-set-method (LSM) variables (phi, dens, mu, phi_init, phi_reinit, phi_new) 
!     are exchanged between the neighbouring subdomains ghost-cells with a different LMR level
!#######################################################################
      use multidata
      use mpi
      use vars
