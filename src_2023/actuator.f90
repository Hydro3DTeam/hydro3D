!#######################################################################
! SUBROUTINES: - act_line_VATT_geom
!              - act_line_VATT
!              - act_line_geom 
!              - actuatorline_initial
!              - actuatorline
!              - actuatorLine_FEM
!              - stallard
!#######################################################################
...
!Multiple blades generation
   ...
   89 FORMAT (10f13.6)
      ...
      RETURN
      END SUBROUTINE act_line_VATT_geom
!#######################################################################
...
!#######################################################################
     ...
     &			master,MPI_COMM_WORLD,ierr)
      ...
      RETURN
      END SUBROUTINE actuatorLine_initial
!#######################################################################
...
! Structural forces:
   ...
   88 FORMAT (1f18.7,18e18.9)
      ...
      RETURN
      END SUBROUTINE actuatorLine_FEM
!#######################################################################
