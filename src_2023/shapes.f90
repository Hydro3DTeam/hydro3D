...
!-----------------------------------------------------------------------
!     Create an organised cloud of point the represent a hemisphere.
!#######################################################################
      use vars
      use multidata
      use imb
...
! 6th row
   ...
   89 FORMAT (3e20.5)
      ...
      RETURN
      END SUBROUTINE imb_hemisphere
!#######################################################################
      SUBROUTINE imb_dune(numIB)
!-----------------------------------------------------------------------
!     Create an organised cloud of point the represent a dune.
!#######################################################################
      use vars
      use multidata
      use imb
...
879	CONTINUE
   ...
   89 FORMAT (3e20.5)
      ...
      RETURN
      END SUBROUTINE imb_dune
!#######################################################################
      SUBROUTINE imb_cone(numIB)
!-----------------------------------------------------------------------
!     Create an organised cloud of point the represent a cone.
!#######################################################################
      use vars
      use multidata
      use imb
...
879	CONTINUE
   ...
   89 FORMAT (3e20.5)
      ...
      RETURN
      END SUBROUTINE imb_cone
!#######################################################################
      SUBROUTINE imb_square(numIB)
!-----------------------------------------------------------------------
!     Create an organised cloud of point the represent a square.
!#######################################################################
      use vars
      use multidata
      use imb
...
!-----------------------------------------------------------------------
!     Create an organised cloud of point the represent a cylinder.
!#######################################################################
      use vars
      use multidata
      use imb
...
!-----------------------------------------------------------------------
!     Create an organised cloud of point the represent a cube.
!#######################################################################
      use vars
      use multidata
      use imb
...
!-----------------------------------------------------------------------
!     Create an organised cloud of point the represent a sphere.
!#######################################################################
      use vars
      use multidata
      use imb
...
!-----------------------------------------------------------------------
!     Create an organised cloud of point for an input file.
!#######################################################################
      use vars
      use multidata
      use imb
...
!-----------------------------------------------------------------------
!     Multiplicate blades of VATT,HATT from a given files.
!#######################################################################
      use vars
      use multidata
      use imb
...
!-----------------------------------------------------------------------
!     Move the geometry for the next time step when it is a moving geometry
!#######################################################################
      use vars
      use multidata
      use imb
...
!-----------------------------------------------------------------------
!     Move the shade for the next time step when it is a moving geometry
!#######################################################################
      use vars
      use multidata
      use imb
...
797	CONTINUE
   ...
   89 FORMAT (3e25.6)
      ...
      RETURN
      END SUBROUTINE imb_moved_shades	
