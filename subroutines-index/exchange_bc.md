...
**File:** exchange\_bc.for\
&#x20; \
**Subroutine Called in:** \
**boundu/v/w** (bounds.for) -> **diffusion** (diffustion.for) -> **flosol** (flosol.for)\
**boundu/v/w** (bounds.for) -> **presure\_1sweep** (press.for) ->  **flosol** (flosol.for)\
**boundu/v/w** (bounds.for) -> **rungek\_conv4th** (rungek.for) -> **flosol** (flosol.for)\
**boundu/v/w** (bounds.for) -> **rungek\_conv2nd** (rungek.for) -> **flosol** (flosol.for)\
**boundu/v/w** (bounds.for) -> **rungek\_convWENO** (rungek.for) -> **flosol** (flosol.for)\
**boundu/v/w** (bounds.for) -> **newsolv\_mg** (newsolv\_mg.for) -> **flosol** (flosol.for)\
__\
__**boundS** (scalar.for) -> **flosol** (flosol.for)\
**boundS** (scalar.for) -> **scalar\_cal** (scalar.for) -> **flosol** (flosol.for)\
**exchange\_Scal** (scalar.for) -> **scalar\_cal** (scalar.for) -> **flosol** (flosol.for)\
\
**boundksgs** (bounds\_keps.for) -> **eddyv\_1eqn** (eddyvis\_1eqn.for) -> **flosol** (flosol.for)\
**boundksgs** (bounds\_keps.for) -> **eddyv\_k** (eddyvis\_keps.for) -> **eddyv\_keps** (eddyvis\_keps.for) -> **flosol** (flosol.for)\
**eddyv\_keps** (eddyvis\_keps.for) -> **flosol** (flosol.for)\
\
**exchange** (exchange.for) **** -> **flosol** (flosol.for)\
**exchange** (exchange.for) **** -> **calvel** (press.for) -> **pressure\_1sweep** (press.for) -> **flosol** (flosol.for)\
**exchange** (exchange.for) **** -> **calvel** (press.for) -> **newsolv\_mg** (newsolvmg.for) -> **flosol** (flosol.for)\
**exchange** (exchange.for) **** -> **newsolv\_mg** (newsolvmg.for) -> **flosol** (flosol.for)\
**exchange** (exchange.for) **** -> **IBM** (ibm.for) -> **flosol** (flosol.for)\
**exchange** (exchange.for) **** -> **sipsol** (sipsol.for) -> **flosol** (flosol.for)\
**exchange** (exchange.for) **** -> **eddyv\_smag** (eddyvis\_smag.for) -> **flosol** (flosol.for)\
**exchange** (exchange.for) **** -> **eddyv\_wale** (eddyvis\_wale.for) -> **flosol** (flosol.for)\
**exchange** (exchange.for) **** -> **eddyv\_1eqn** (eddyvis\_1eqn.for) -> **flosol** (flosol.for)\
**exchange** (exchange.for) **** -> **eddyv\_keps** (eddyvis\_keps.for) -> **flosol** (flosol.for)\
**exchange** (exchange.for) **** -> **exchange\_Scal** (scalar.for) ->  **scalar\_cal** (scalar.for) -> **flosol** (flosol.for)\
**exchange** (exchange.for) **** -> **bound\_LSM** (bounds\_lsm.for) ->  **lsm\_3d** (lsm.for) ->  **flosol** (flosol.for)\
**exchange** (exchange.for) **** -> **bound\_LSM** (bounds\_lsm.for) ->  **tvd\_rk\_reinit** (lsm.for) -> **initial\_lsm3d\_channel** (lsm.for) -> **fdstag** (fdstag.for)\
**exchange** (exchange.for) **** -> **bound\_LSM** (bounds\_lsm.for) -> **tvd\_rk\_renit** (lsm.for) -> **lsm\_3d** (lsm.for) -> **flosol** (flosol.for)\
**exchange** (exchange.for) **** -> **bound\_LSM** (bounds\_lsm.for) -> **heaviside** (lsm.for) -> **flosol** (flosol.for)\
\
\
**Purpose:**\
****This subroutine ensures that the value of the computational boundary is exchanged between its opposite faces when the periodic boundary condition is selected. (West <-> East) | (South <-> North) | (Bottom <-> Top)  \
\
