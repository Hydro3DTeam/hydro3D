...
**File:** bounds\_lsm._for_\
__\
__**Subroutine Called in:**\
**lsm\_3d** (lsm.for) ->  **flosol** (flosol.for)\
**tvd\_rk\_reinit** (lsm.for) -> **initial\_lsm3d\_channel** (lsm.for) -> **fdstag** (fdstag.for)\
**tvd\_rk\_renit** (lsm.for) -> **lsm\_3d** (lsm.for) -> **flosol** (flosol.for)\
**heaviside** (lsm.for) -> **flosol** (flosol.for)\
\
**Purpose:**\
****\
